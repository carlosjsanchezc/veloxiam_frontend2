...
export class ContactsDetailsComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private mc:ContactsListComponent
    )
    {
    }
    ...
    updateContact(): void
    {
        ...
        this._contactsService.updateContact(contact.id,contact).then(data=>{
            let d:any=data;
            contact=d;
            this.contact=d;
            console.log("Antes",this.mc.myContacts);
            this.mc.myContacts.forEach((element,index) => {
                if (element.id===contact.id){
                    console.log("Encontro");
                    console.log(this.contact);
                    this.mc.myContacts[index]=this.contact;
                }
            });
            console.log("Despues",this.mc.myContacts)
            this.mc._changeDetectorRef.markForCheck();
...
/*
    ...
    deleteContact()
    {
        ...
        this._contactsService.deleteContact(id).then(data=>{
            this.mc.ngOnInit();
            this._contactsListComponent.matDrawer.close();
